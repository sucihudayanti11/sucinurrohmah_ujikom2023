...
<h3 style class="purple-text"><center>Login</center></h3>
	<form method="POST">
		<div class="input_field" >
			<label for="username"><font color="purple">Username</font></label>
			<input id="username" type="text" name="username" required>
		</div>
		<div class="input_field"  color:purple ;>
			<label for="password"><font color="purple">Password</font></label>
			<input id="password" type="password" name="password" required>
		</div>
		<input type="submit" name="login" value="Login" class="btn purple" style="width: 100%;">
