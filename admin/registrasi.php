        <div class="row">
          <div class="col s12 m9">
            <h3 class="purple-text">Masyarakat</h3>
          </div>  
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect waves-light btn modal-trigger purple" href="#modal1">Tambah</a>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn purple modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" class="btn red" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>">Hapus</a></td>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="regis_edit?nik=<?php echo $r['nik'] ?>" class="modal">
          ...
          <div class="modal-footer">
            <a href="#!" class="modal-close waves-effect waves-green btn-purple">Close</a>
          </div>
        </div>
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
