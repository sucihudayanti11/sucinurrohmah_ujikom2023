        <div class="row">
          <div class="col s12 m9">
            <h3 class="purple-text">User</h3>
          </div>  
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect  btn modal-trigger purple" href="#modal1">TAMBAH</a>
          </div>
        </div>
        ...
        <table id="example" class="display responsive-table" style="width:100%">
          <thead>
              <tr>
				<th><font color="green">No</font></th>
				<th><font color="green">Nama</font></th>
				<th><font color="green">Username</font></th>
				<th><font color="green">Telephone</font></th>
				<th><font color="green">level</font></th>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn purple modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a class="red btn" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="user_edit<?php echo $r['id_petugas'] ?>" class="modal">
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					...
					<p>
						<label>
						  <input value="admin" class="with-gap purple" name="level" type="radio" <?php if($r['level']=="admin"){echo "checked";} ?> />
						  <span>Admin</span>
						</label>
						<label>
						  <input value="petugas" class="with-gap purple" name="level" type="radio" <?php if($r['level']=="petugas"){echo "checked";} ?> />
						  <span>Petugas</span>
						</label>
					</p>
				</div>
				<div class="col s12 input-field">
					<input type="submit" name="Update" value="Simpan" class="btn right-purple purple">
				</div>
			</form>
          ...
          <div class="modal-footer">
            <a href="#!" class="btn right-purple purple">Close</a>
          </div>
        </div>
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="modal1" class="modal">
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					<input type="submit" name="input" value="Simpan" class="btn right purple">
				</div>
			</form>
