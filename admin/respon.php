	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn purple modal-trigger" href="#more?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Lainnya</a> <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=tanggapan_hapus&id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Hapus</a></td>
