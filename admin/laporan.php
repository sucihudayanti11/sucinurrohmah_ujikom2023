        <div class="row">
          <div class="col s12 m9">
            <h3 class="purple-text">Laporan</h3>
          </div> 
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect waves-light btn purple" href="cetak.php">Cetak</a>
          </div>
        </div>
        ...
        <table id="example" class="display responsive-table" style="width:100%">
          <thead>
              <tr>
				...
				<th><font color="green">NIK Pelapor</font></th>
				<th><font color="green">Nama Pelapor</font></th>
				<th><font color="green">Nama Petugas</font></th>
				<th><font color="green">Tanggal Masuk Pengaduan</font></th>
				<th><font color="green"><b>Tanggal Ditanggapi</b></font></th>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn purple modal-trigger" href="#laporan?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Detail</a></td>
