<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/ii.jpg); background-size: cover;">
              ...
              <li>
                  <div class="user-view">
                      <div class="background">
                          <img src="../img/polosss.jpg">
                      </div>
                      <a href="#user"><img class="circle" src="../img/petugas.jpg"></a>
                      <a href="#name"><span class="white-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard"><font color="purple">Dashboard</font></a>
              <li><a href="index.php?p=registrasi"><font color="purple">Registrasi</font></a>
              <li><a href="index.php?p=pengaduan"><font color="purple">Pengaduan</font></a>
              <li><a href="index.php?p=respon"><font color="purple">Respon</font></a></li>
              <li><a href="index.php?p=user"><font color="purple">User</font></a>
              <li><a href="index.php?p=laporan"><font color="purple">Laporan</font></a>
              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="waves-effect" href="../index.php?p=logout"><font color="purple">Logout</font></a>
          </ul>
