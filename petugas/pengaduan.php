        <div class="row">
          <div class="col s12 m9">
            <h3 class="purple-text">Pengaduan</h3>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn modal-trigger purple" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Detail</a>  <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
        ...
        <div id="more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
          <div class="modal-content">
            ...
            <div class="col s12 m6">
				...
				<p>Tanggal Pengaduan : <?php echo $r['tgl_pengaduan']; ?></p>
				<?php 
					if($r['foto']=="kosong"){ ?>
            ...
            <?php 
	            ...
	            <div class="col s12 m6">
					<form method="POST">
						...
						<div class="col s12 input-field">
							<input type="submit" name="tanggapi" value="Kirim" class="btn right purple">
						</div>
					</form>
	            </div>
            <?php	}
