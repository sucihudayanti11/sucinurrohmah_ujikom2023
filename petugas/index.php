<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/iii.jpg); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="../img/yona.jpg"></a>
              ...
              <li><a href="index.php?p=respon"><font color="purple">Di Tanggapi<font></a>
              <li>
