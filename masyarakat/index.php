          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="../img/bulan.jpg"></a>
                      <a href="#name"><span class="white-text name"><?php echo ucwords($_SESSION['data']['nama']); ?></span></a>
                  </div>
                  
              </li>
              <li><a href="index.php?p=dashboard"><i class="material-icons">dashboard</i>Laporan</a></li>
              <li>
              </li>
              <li><a href="index.php?p=dashboard1"><i class="material-icons">note</i>Pengaduan Saya</a></li>
    ...
    elseif(@$_GET['p']=="dashboard1"){
		...
		elseif(@$_GET['p']=="pengaduan_hapus"){
			...
			if($data['status']=="proses"){
				...
				header('location:index.php?p=dashboard1');
			}
